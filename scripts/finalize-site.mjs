...
function patchHtml(filename) {
  ...
  const headerLogo = `\n        <a class="wordmark" href="${home}" aria-label="${homeLabel}">\n          <span class="brand-logo-swap" aria-hidden="true">\n            <img class="brand-logo brand-logo-header brand-logo-header-on-dark" src="assets/logo-detex-horizontal-light.svg" alt="" width="540" height="117" />\n            <img class="brand-logo brand-logo-header brand-logo-header-on-light" src="assets/logo-detex-horizontal.svg" alt="" width="540" height="117" />\n          </span>\n        </a>\n`;
  ...
  const footerLogo = `\n          <a href="${home}" aria-label="${homeLabel}">\n            <img class="brand-logo brand-logo-footer" src="assets/logo-detex-footer.svg" alt="" width="540" height="117" />\n          </a>\n`;
